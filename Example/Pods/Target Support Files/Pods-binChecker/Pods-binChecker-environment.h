...
// binChecker
#define COCOAPODS_POD_AVAILABLE_binChecker
#define COCOAPODS_VERSION_MAJOR_binChecker 0
#define COCOAPODS_VERSION_MINOR_binChecker 1
#define COCOAPODS_VERSION_PATCH_binChecker 0
